    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "email_address",
                    models.EmailField(blank=True, max_length=254, null=True, verbose_name="Email Address"),
                ),
                ("wechat_id", models.CharField(blank=True, max_length=255, null=True, verbose_name="Wechat ID")),
                (
                    "groups",
